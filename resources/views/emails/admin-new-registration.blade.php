...
<head>
  ...
  <title>New Registration – Admin Alert</title>
  <style>
...
<div class="wrapper">
  <div class="container">
    ...
    <div class="body">
      ...
      <p>A new user has registered on the eVoucher Food Support Platform and is awaiting approval.</p>
      <div class="info-box">
    ...
    <div class="cta-wrap">
      <a href="{{ $adminUrl }}" class="cta-btn">Review Registration</a>
    </div>
